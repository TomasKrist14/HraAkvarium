...
class Game(tk.Tk):
    ...
    def create_background(self):
        self.bg = tk.PhotoImage(file="../../Downloads/akvarium/background.png")
    ...
    def game_over(self):
        ...
        self.f = self.display_food_stats("../../Downloads/akvarium/food/flake_icon.png", f, 300)
        self.w1 = self.display_food_stats("../../Downloads/akvarium/food/worm1_icon.png", w1, 350)
        self.w2 = self.display_food_stats("../../Downloads/akvarium/food/worm2_icon.png", w2, 400)
        self.p = self.display_food_stats("../../Downloads/akvarium/food/pellet_icon.png", p, 450)
...
class Worm1(Food):
    ...
    def __init__(self, canvas):
        ...
        self.sprites = self.load_sprites("../../Downloads/akvarium/food/worm1.png", 1, 1)
...
class Worm2(Food):
    ...
    def __init__(self, canvas):
        super().__init__(canvas)
        self.sprites = self.load_sprites("../../Downloads/akvarium/food/worm2.png", 1, 1)
        self.canvas.itemconfig(self.id, image=self.sprites[0])
...
class Pellet(Food):
    ...
    def __init__(self, canvas):
        super().__init__(canvas)
        self.sprites = self.load_sprites("../../Downloads/akvarium/food/pellet.png", 1, 1)
        self.canvas.itemconfig(self.id, image=self.sprites[0])
...
class Player(BaseSprite):
    ...
    def load_all_sprites(self):
        ...
        sprite_sheet[self.IDLE][self.LEFT] = self.load_sprites(
            "../../Downloads/akvarium/player/left_idle.png", 5, 4)
        sprite_sheet[self.IDLE][self.RIGHT] = self.load_sprites(
            "../../Downloads/akvarium/player/right_idle.png", 5, 4)
        sprite_sheet[self.SWIM][self.LEFT] = self.load_sprites(
            "../../Downloads/akvarium/player/left_swim.png", 3, 4)
        sprite_sheet[self.SWIM][self.RIGHT] = self.load_sprites(
            "../../Downloads/akvarium/player/right_swim.png", 3, 4)
        return sprite_sheet
